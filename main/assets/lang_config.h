...
namespace Lang {
    ...
    namespace Sounds {
        ...
        extern const char p3_popup_end[] asm("_binary_popup_p3_end");
        static const std::string_view P3_POPUP {
        static_cast<const char*>(p3_popup_start),
        static_cast<size_t>(p3_popup_end - p3_popup_start)
        };

        extern const char p3_start_ota_start[] asm("_binary_start_ota_p3_start");
        extern const char p3_start_ota_end[] asm("_binary_start_ota_p3_end");
        static const std::string_view P3_START_OTA {
        static_cast<const char*>(p3_start_ota_start),
        static_cast<size_t>(p3_start_ota_end - p3_start_ota_start)
        };
